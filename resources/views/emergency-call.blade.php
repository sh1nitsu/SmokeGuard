<x-app-layout>
    ...
    <a class="p-2 rounded-md" href="{{ asset('emergency') }}">
    ...
    <img name="img" src="{{ asset('storage/call.png') }}" alt="img" class="h-[200px]" >
    </div>  

    <div class="flex items-center justify-center mt-10">
        <x-primary-button class="w-11/12 py-3 flex justify-center">
            <a href="{{asset('emergency')}}">{{ __('Cancel') }}</a>
        </x-primary-button>
    </div>
    ...
    {{-- <div class="pt-5">
        <div class="w-11/12 mx-auto sm:px-6 lg:px-8 ">
            <div class="p-3 bg-red-500 overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="w-11/12 mx-auto sm:px-6 lg:px-8">
            <div class="p-3 bg-red-500 overflow-hidden shadow-sm sm:rounded-lg mt-2">
                <div class="text-white font-bold text-center">
